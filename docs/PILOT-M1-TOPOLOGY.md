...
| Arnés | `tests/pilot/` | `358` pruebas de topología, activación de organización, preflight del projector e inicialización segura de secretos; la CI contrasta este censo con los casos recogidos |
